...
import { contentTypes as contentTypesUtils, errors } from '@kazuki.m---strapi/utils';
import type { UID, Struct } from '@kazuki.m---strapi/types';
...
export const generateAPI = ({
  ...
  const strapiGenerators = require('@kazuki.m---strapi/generators');
