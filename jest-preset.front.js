...
const moduleNameMapper = {
  '.*\\.(css|less|styl|scss|sass)$': '@kazuki.m---strapi/admin-test-utils/file-mock',
  '.*\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga|ico)$':
    '@kazuki.m---strapi/admin-test-utils/file-mock',
  /**
...
module.exports = {
  ...
  globalSetup: '@kazuki.m---strapi/admin-test-utils/global-setup',
  setupFiles: ['@kazuki.m---strapi/admin-test-utils/setup'],
  setupFilesAfterEnv: ['@kazuki.m---strapi/admin-test-utils/after-env'],
  testEnvironment: '@kazuki.m---strapi/admin-test-utils/environment',
