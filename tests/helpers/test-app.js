...
const generateTestApp = async ({ appPath, database, template, link = false }) => {
  ...
  const scope = {
    ...
    dependencies: {
      '@kazuki.m---strapi/strapi': pkg.version,
      '@kazuki.m---strapi/plugin-users-permissions': pkg.version,
      '@kazuki.m---strapi/plugin-graphql': pkg.version,
      '@kazuki.m---strapi/plugin-documentation': pkg.version,
      '@kazuki.m---strapi/plugin-cloud': pkg.version,
      react: '18.2.0',
      'react-dom': '18.2.0',
